...
slug: /develop/copilot/usage-limits
---
...
![The usage indicator in the Copilot panel header.](/img/develop/copilot/usage-badge.png)
...
![The Request additional quota form.](/img/develop/copilot/quota-request-form.png)
...
![The message confirming that a request has been submitted.](/img/develop/copilot/quota-request-submitted.png)
...
- [Getting started](getting-started.md) — Sign in to WSO2 Integrator Copilot, including with your own AI provider credentials.
- [AI usage and data handling guidelines](../../reference/ai-usage-and-data-handling-guidelines.md) — How Copilot handles your data, and the bring your own key options.
